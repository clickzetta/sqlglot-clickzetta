...
PARTITION p201702 VALUES LESS THAN ('2017-03-01')
    ...
    def test_presto_syntax_support(self):
        ...
        self.validate_all(
            "SELECT DATE_FORMAT_MYSQL(CURRENT_DATE, 'yyyyMMdd')",
            read={"presto": "SELECT format_datetime(current_date(), 'yyyyMMdd')"},
            write={"clickzetta": "SELECT DATE_FORMAT_MYSQL(CURRENT_DATE, 'yyyyMMdd')"},
        )
        ...
        self.validate_all(
            "SELECT TIMESTAMP_OR_DATE_ADD('DAY', 364, DATE_FORMAT_MYSQL(TIMESTAMP_OR_DATE_ADD('DAY', 1, CURRENT_DATE), 'yyyyMMdd'))",
            read={"presto": "SELECT date_add(format_datetime(date_add(current_date(), 1), 'yyyyMMdd'), 364)"},
            write={"clickzetta": "SELECT TIMESTAMP_OR_DATE_ADD('DAY', 364, DATE_FORMAT_MYSQL(TIMESTAMP_OR_DATE_ADD('DAY', 1, CURRENT_DATE), 'yyyyMMdd'))"},
        )
